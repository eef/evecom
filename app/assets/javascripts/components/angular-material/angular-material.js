function mdMediaFactory(e, t, n, o) {
  ...
  function l() {
    var e = s.keys(),
      t = e.length;
    if (t) {
      for (var o = 0; t > o; o++) i(e[o]);
      n.$evalAsync()
    }
  }
  var d = t.cacheFactory("$mdMedia:queries", {
      capacity: 15
    }),
    s = t.cacheFactory("$mdMedia:results", {
      capacity: 15
    });
  ...
  function(e, t, n, o) {
    ...
    function l(e, t, n) {
      for (var a = Object.keys(t), r = 0; r < a.length;)(!n || n && e[a[r]] === o) && (e[a[r]] = t[a[r]]), r++;
      return e
    }
    ...
    function T(e, t) {
      for (var n, a, r = t[0].toUpperCase() + t.slice(1), i = 0; i < dt.length;) {
        if (n = dt[i], a = n ? n + r : t, a in e) return a;
        i++
      }
      return o
    }
    ...
    function k(e, t) {
      var n = t.center,
        ...
        a = e.prevDelta || {},
        r = e.prevInput || {};
      (t.eventType === xt || r.eventType === wt) && (a = e.prevDelta = {
        x: r.deltaX || 0,
        y: r.deltaY || 0
      }, o = e.offsetDelta = {
        x: n.x,
        y: n.y
      }), t.deltaX = a.x + (n.x - o.x), t.deltaY = a.y + (n.y - o.y)
    }

    function S(e, t) {
      var n, a, r, i, l = e.lastInterval || t,
        d = t.timeStamp - l.timeStamp;
      if (t.eventType != Ct && (d > Mt || l.velocity === o)) {
        var s = l.deltaX - t.deltaX,
          c = l.deltaY - t.deltaY,
          m = H(d, s, c);
        a = m.x, r = m.y, n = ut(m.x) > ut(m.y) ? m.x : m.y, i = D(s, c), e.lastInterval = t
      } else n = l.velocity, a = l.velocityX, r = l.velocityY, i = l.direction;
      t.velocity = n, t.velocityX = a, t.velocityY = r, t.direction = i
    }

    function N(e) {
      for (var t = [], n = 0; n < e.pointers.length;) t[n] = {
        clientX: mt(e.pointers[n].clientX),
        clientY: mt(e.pointers[n].clientY)
      }, n++;
      return {
        timeStamp: pt(),
        pointers: t,
    ...
    function _(e) {
      ...
      for (var n = 0, o = 0, a = 0; t > a;) n += e[a].clientX, o += e[a].clientY, a++;
      return {
        x: mt(n / t),
        y: mt(o / t)
      }
    ...
    function q(e, t) {
      var n = E(e.touches),
        o = this.targetIds;
      if (t & (xt | At) && 1 === n.length) return o[n[0].identifier] = !0, [n, n];
      var a, r, i = E(e.changedTouches),
        l = [],
        d = this.target;
      if (r = n.filter(function(e) {
          return f(e.target, d)
        }), t === xt)
        for (a = 0; a < r.length;) o[r[a].identifier] = !0, a++;
      for (a = 0; a < i.length;) o[i[a].identifier] && l.push(i[a]), t & (wt | Ct) && delete o[i[a].identifier], a++;
    ...
    s(R, x, {
      handler: function(e) {
        var t = Rt[e.type];
        t & xt && 0 === e.button && (this.pressed = !0), t & At && 1 !== e.which && (t = wt), this.pressed && this.allow && (t & wt && (this.pressed = !1), this.callback(this.manager, t, {
          pointers: [e],
          changedPointers: [e],
          pointerType: Tt,
          srcEvent: e
    ...
    e.MSPointerEvent && (qt = "MSPointerDown", zt = "MSPointerMove MSPointerUp MSPointerCancel"), s(O, x, {
      handler: function(e) {
        var t = this.store,
          n = !1,
          o = e.type.toLowerCase().replace("ms", ""),
          a = Lt[o],
          r = Ft[e.pointerType] || e.pointerType,
          i = r == Et,
          l = v(t, e.pointerId, "pointerId");
        a & xt && (0 === e.button || i) ? 0 > l && (t.push(e), l = t.length - 1) : a & (wt | Ct) && (n = !0), 0 > l || (t[l] = e, this.callback(this.manager, a, {
          pointers: t,
          changedPointers: [e],
          pointerType: r,
          srcEvent: e
    ...
    s(U, x, {
      handler: function(e) {
        ...
        if (t === xt && (this.started = !0), this.started) {
          ...
          t & (wt | Ct) && n[0].length - n[1].length === 0 && (this.started = !1), this.callback(this.manager, t, {
            pointers: n[0],
            changedPointers: n[1],
            pointerType: Et,
            srcEvent: e
    ...
    Y.prototype = {
      ...
      canEmit: function() {
        for (var e = 0; e < this.requireFail.length;) {
          if (!(this.requireFail[e].state & (mn | an))) return !1;
          e++
        }
        return !0
      },
      ...
      process: function(e) {
        ...
        if (this._input = e, !o || !n || e.eventType & (wt | Ct) && !r) this.reset();
        else if (e.eventType & xt) this.reset(), this._timer = a(function() {
          this.state = sn, this.tryEmit()
        }, t.time, this);
        else if (e.eventType & wt) return sn;
        return mn
      },
      reset: function() {
    ...
    rt.prototype = {
      ...
      recognize: function(e) {
        ...
        if (!t.stopped) {
          ...
          for (var r = 0; r < o.length;) n = o[r], t.stopped === pn || a && n != a && !n.canRecognizeWith(a) ? n.reset() : n.recognize(e), !a && n.state & (rn | ln | dn) && (a = t.curRecognizer = n), r++
        }
      },
      get: function(e) {
  ...
  function() {
    ...
    function t(e, t) {
      ...
      e.decorator("$$rAF", ["$delegate", "$rootScope", n]), t.theme("default").primaryPalette("blue-grey").accentPalette("pink").warnPalette("red").backgroundPalette("grey")
    }
  ...
  function() {
    ...
    angular.module("material.core").factory("$mdUtil", ["$cacheFactory", "$document", "$timeout", function(t, n, o) {
      function a(e, t) {
        ...
        function a(e) {
          var n = e.type.charAt(0),
            o = i.now();
          u && u.pointerType !== n && o - u.endTime < 400 || p || (p = !0, m = {
            pointerType: n,
            startX: s(e),
            startTime: o
        ...
        var m, u, p, h = "mousedown touchstart pointerdown",
          f = "mousemove touchmove pointermove",
          g = "mouseup mouseleave touchend touchcancel pointerup pointercancel";
  ...
  function() {
    ...
    function e() {
      function e(e) {
        ...
        }), o.$inject = ["$$interimElement", "$animate", "$injector"], i
      }
  ...
  function() {
    ...
    function t(e, t) {
      ...
      function r(n, o, a) {
        ...
        function i(e, n) {
          h.splice(h.indexOf(e), 1), 0 === h.length && c && c.css({
            backgroundColor: ""
          }), t(function() {
            e.remove()
          }, n, !1)
        ...
        function l(e) {
          var t = h.indexOf(e),
            ...
            o = h.length > 1 ? !1 : b,
            r = h.length > 1 ? !1 : v;
          o || n.animating || r ? e.addClass("md-ripple-visible") : e && (e.removeClass("md-ripple-visible"), a.outline && e.css({
            width: m + "px",
            height: m + "px",
            marginLeft: -1 * m + "px",
            marginTop: -1 * m + "px"
          }), i(e, a.outline ? 450 : 650))
        }

        function d(n, i) {
          function d(e) {
            var t = angular.element('<div class="md-ripple" data-counter="' + p++ +'">');
            return h.unshift(t), f.unshift({
              animating: !0
            }), b.append(t), e && t.css(e), t
          }

          function s(e, t) {
            var n, o, r, i = b.prop("offsetWidth"),
              l = b.prop("offsetHeight");
          ...
          return m = v, x.animating = !0, t(function() {
            a.dimBackground && b.css({
              backgroundColor: T
            }), $.addClass("md-ripple-placed md-ripple-scaled"), a.outline ? $.css({
              borderWidth: .5 * v + "px",
              marginLeft: v * -.5 + "px",
              marginTop: v * -.5 + "px"
            }) : $.css({
        ...
        var c, m, u = o.controller("mdInkRipple") || {},
          p = 0,
          h = [],
          f = [],
          g = o.attr("md-highlight"),
          b = !1,
          v = !1,
          E = o[0],
          y = new Hammer(E),
    ...
    function e(e) {
          ...
          if (e = 0 === arguments.length ? !0 : !!e, e !== n.isDark) {
            ...
            return angular.forEach(t, function(e, t) {
              var a = n.colors[t],
                r = o[t];
              if (a)
                for (var i in a.hues) a.hues[i] === r[i] && (a.hues[i] = e[i])
            }), n
          }
        }
        var n = this;
        n.name = e, n.colors = {}, n.dark = t, t(!1), E.forEach(function(e) {
          ...
          n[e + "Palette"] = function(o, a) {
            ...
            return Object.keys(r.hues).forEach(function(e) {
              ...
              if (-1 == M.indexOf(t)) throw new Error("Invalid hue value '%1' in theme %2's %3 color %4. Available hue values: %5".replace("%1", t).replace("%2", n.name).replace("%3", e).replace("%4", o).replace("%5", M.join(", ")))
            }), n
          }, n[e + "Color"] = function() {
      ...
      function m(e) {
        ...
        return t.inherit = function(t, n) {
          ...
          var a = n.controller("mdTheme"),
            r = t.attr("md-theme-watch");
      ...
      var g = "default",
        b = !1;
      return angular.extend(d, e), m.$inject = ["$rootScope"], c = {
        definePalette: t,
        extendPalette: n,
        theme: r,
  ...
  function() {
    ...
    function t(e) {
      function t(e, t, n, o, a, r, i, l) {
        ...
        function c(e) {
          ...
          var c, m, u, p, h, f = 80,
            g = 20,
            b = 10;
          return e = e.eq(0), e.on("touchstart", o).on("touchmove", r).on("touchend", a), {
            element: e,
            cleanup: function() {
      ...
      return t.$inject = ["$animate", "$mdConstant", "$timeout", "$$rAF", "$compile", "$mdTheming", "$mdBottomSheet", "$rootElement"], e("$mdBottomSheet").setDefaults({
        options: t
      })
    }
      ...
      function i(t, i) {
        return i.type = "checkbox", i.tabIndex = 0, t.attr("role", i.type),
          function(i, d, s, c) {
            ...
            c = c || r.fakeNgModel();
            var h = !1;
            a(d), n.expectWithText(t, "aria-label"), e.link.pre(i, {
              on: angular.noop,
              0: {}
            }, s, [c]), s.mdNoClick || d.on("click", u), d.on("keypress", m), c.$render = p
          }
      }
      e = e[0];
      var l = "md-checked";
        ...
        function b(e, t) {
          if (t) {
            var n = t[0].getBoundingClientRect(),
              ...
              a = Math.min(.5, n.width / o.width),
              r = Math.min(.5, n.height / o.height);
  ...
  function() {
    function e(e) {
      ...
      return n.$inject = ["$scope", "$element", "$mdUtil"], {
        restrict: "E",
        link: t,
        controller: n
      }
    ...
    function e(e, t, n) {
      ...
      function a(e, o, a) {
        ...
        u.style[t.CSS.TRANSFORM] = "scale(" + g.toString() + ")", a.$observe("value", function(e) {
          for (s = r(e), c = i[s], m = l[s], o.attr("aria-valuenow", s), d = 0; d < p.length; d++) p[d].style[t.CSS.TRANSFORM] = c;
          for (d = 0; d < h.length; d++) h[d].style[t.CSS.TRANSFORM] = m
        })
      }
      ...
      function i(t, n) {
        ...
        if (o.count()) {
          var a = function(e) {
            ...
            i = o[0 > n ? "previous" : "next"](r, a) || o.first();
  ...
  function() {
    ...
    function e(e, t) {
      return function(n) {
        var o = "SideNav '" + n + "' is not available!",
          a = e.get(n);
        return a || e.notFoundError(n), {
          isOpen: function() {
            return a && a.isOpen()
          },
      ...
      this.init = function(d) {
        ...
        function h() {
          if (angular.isDefined(n.mdDiscrete)) {
            ...
            for (var r, i = 0; e >= i; i++) r = Math.floor(o.width * (i / e)), W.fillRect(r - 1, 0, 2, o.height)
          }
        }
        ...
        var H = angular.element(t[0].querySelector(".md-thumb")),
          D = angular.element(t[0].querySelector(".md-thumb-text")),
          P = H.parent(),
          I = angular.element(t[0].querySelector(".md-track-container")),
          j = angular.element(t[0].querySelector(".md-track-fill")),
          B = angular.element(t[0].querySelector(".md-track-ticks")),
          R = i.throttle(f, 5e3);
        ...
        f();
        var G = !1,
          K = angular.isDefined(n.mdDiscrete);
  ...
  function() {
    ...
    function e() {
      return function(e, t) {
        return t || (t = "swipeleft swiperight"),
          function(n, o, a) {
            function r(t) {
            ...
            function l(e, t) {
              var n = t.indexOf("pan") > -1,
                o = t.indexOf("swipe") > -1;
              return n && e.push([Hammer.Pan, {
                direction: Hammer.DIRECTION_HORIZONTAL
              }]), o && e.push([Hammer.Swipe, {
                direction: Hammer.DIRECTION_HORIZONTAL
              }]), e
            }
            var d = new Hammer(n[0], {
              recognizers: l([], t)
            });
      ...
      function l(e, t) {
        ...
        return e.addClass("md-dragging"),
          function(e, t, l, d) {
            ...
            d = d || n.fakeNgModel();
            var u = r(l.ngDisabled),
              p = angular.element(t[0].querySelector(".md-thumb-container")),
              h = angular.element(t[0].querySelector(".md-container"));
            i(function() {
    ...
    function e(e, t, n, o) {
      return {
        ...
        compile: function(a, r) {
          return o.warn("<md-text-float> is deprecated. Please use `<md-input-container>` and `<input>`.More information at http://material.angularjs.org/#/api/material.components.input/directive/mdInputContainer"), angular.isUndefined(r.mdFid) && (r.mdFid = t.nextUid()), {
            pre: function(e, t, o) {
    ...
    function e(e, t, n, o, a, r, i) {
      function l(l, c, m) {
        ...
        function f() {
          ...
          o.left = Math.min(o.left, v.prop("scrollWidth") - e.width - s), o.left = Math.max(o.left, s), o.top + e.height > v.prop("scrollHeight") && (o.top = t.top - e.height, n = "top"), c.css({
            top: o.top + "px",
            left: o.left + "px"
          }), c.attr("width-32", Math.ceil(e.width / 32)), c.attr("md-direction", n)
        }
        r(c);
        for (var g = c.parent(), b = c.parent()[0]; b && b !== i[0] && b !== document.body && (!b.tagName || "md-content" != b.tagName.toLowerCase());) b = b.parentNode;
      ...
      function t(t, o, a, r) {
        function i() {
          ...
          if (o.css("display", a ? "none" : "block"), !a && t.pagination && t.pagination.tabData) {
            var r = l.getSelectedIndex(),
              i = t.pagination.tabData.tabs[r] || {
                  left: 0,
                  right: 0,
                  width: 0
                },
              d = o.parent().prop("offsetWidth") - i.right,
              s = ["md-transition-left", "md-transition-right", "md-no-transition"],
              c = n > r ? 0 : r > n ? 1 : 2;
            o.removeClass(s.join(" ")).addClass(s[c]).css({
              left: i.left + 1 + "px",
              right: d + "px"
            }), n = r
          }
  ...
  function() {
    ...
    function e(e, t, n, o, a, r) {
      function i(i, d, s, c) {
        ...
        function u(e) {
          var t = $.tabData,
            n = Math.max(0, Math.min(t.pages.length - 1, $.page + e)),
            o = t.pages[n][e > 0 ? "firstTabIndex" : "lastTabIndex"],
            a = c.itemAt(o);
          m(a)
        }
        ...
        function h(t) {
          ...
          if (c.pagingOffset === t) return o.when();
          var a = o.defer();
        ...
        function g(e) {
          function t() {
            var e = 1 === m.length ? o : a,
              t = Math.min(Math.floor(e / s), E.length),
              n = Math.floor(e / t);
            return r.css("width", n + "px"), g(!0)
          }
          var n, o = d.parent().prop("offsetWidth"),
            a = o - l - 1,
            r = angular.element(E),
            i = 0,
            s = 0,
          ...
          return r.css("max-width", ""), angular.forEach(E, function(e, t) {
            var r = Math.min(a, e.offsetWidth),
              l = {
                element: e,
                left: i,
                width: r,
            ...
            l.page = Math.ceil(l.right / (1 === m.length && t === E.length - 1 ? o : a)) - 1, l.page >= m.length ? (l.filler = a * l.page - l.left, l.right += l.filler, l.left += l.filler, n = {
              left: l.left,
              firstTabIndex: t,
              lastTabIndex: t,
              tabs: [l]
            }, m.push(n)) : (n.lastTabIndex = t, n.tabs.push(l)), i = l.right, s = Math.max(s, r), c.push(l)
          }), r.css("max-width", a + "px"), !e && f() ? t() : {
            width: i,
            max: s,
            tabs: c,
            pages: m,
    ...
    function e(e, t, n, o, a) {
      function r(r, i) {
        ...
        return function(r, i, s, c) {
          ...
          var T = e.attachTabBehavior(r, i, {
            colorElement: y.inkBarElement
          });
          ...
          t.$watch("selectedIndex", function(e, t) {
            if (t != e) {
              ...
              if (a.deselect(a.itemAt(t), n), a.inRange(e)) {
                for (var o = a.itemAt(e); o && o.isDisabled();) o = e > t ? a.next(o) : a.previous(o);
                a.select(o, n)
              }
            }
          })
...
var DocsApp = angular.module("docsApp", ["ngMaterial", "ngRoute", "angularytics", "ngMessages"]).config(["COMPONENTS", "DEMOS", "PAGES", "$routeProvider", "$mdThemingProvider", function(e, t, n, o, a) {
  o.when("/", {
    ...
    angular.forEach(e, function(e) {
      t.name === e.name && (n = e)
    }), n = n || angular.extend({}, t), o.when(t.url, {
  ...
  angular.forEach(t, function(e) {
    ...
    name: "Services",
    pages: s.service.sort(r)
  }), l.push({
    name: "Directives",
    pages: s.directive.sort(r)
  });
  var m;
  return a.$on("$locationChangeSuccess", i), m = {
    sections: l,
...
DocsApp.constant("BUILDCONFIG", {
  ...
  commit: "1c973330c68e0c653a19f4408a373741107eb0e3",
  date: "2015-01-21 21:55:45 -0500"
  ...
  function e(e, t, n, o) {
    ...
    var r = this;
    r.interpolateCode = angular.isDefined(n.interpolateCode), r.demoId = o(n.demoId || "")(e.$parent), r.demoTitle = o(n.demoTitle || "")(e.$parent), r.demoModule = o(n.demoModule || "")(e.$parent), r.files = {
      css: [],
      js: [],
      html: []
  ...
  return {
    ...
    compile: function(o, a) {
      var r;
      return a.code || (r = o.html(), o.empty()),
        function(o, a, i) {
          function l(e, t) {
            var n = t.find("code"),
              o = e.split("\n");
...
var hljs = new function() {
  ...
  function r(e) {
    ...
    return function o(e, a) {
      for (var r = e.firstChild; r; r = r.nextSibling) 3 == r.nodeType ? a += r.nodeValue.length : "br" == t(r) ? a += 1 : 1 == r.nodeType && (n.push({
        event: "start",
        offset: a,
        node: r
      }), a = o(r, a), n.push({
  ...
  function d(t, o, a, r) {
    ...
    function y(t, n) {
      var o = t.cN ? p(t.cN, "", !0) : "";
      t.rB ? (x += o, w = "") : t.eB ? (x += e(n) + o, w = "") : (x += o, w = n), M = Object.create(t, {
        parent: {
          value: M
        }
      })
    ...
    function T(t, n) {
      if (w += t, void 0 === n) return x += g(), 0;
      var o = i(n, M);
      if (o) return x += g(), y(o, n), o.rB ? 0 : n.length;
      var a = c(M, n);
      if (a) {
        var r = M;
        r.rE || r.eE || (w += n), x += g();
        do M.cN && (x += "</span>"), C += M.r, M = M.parent; while (M != a.parent);
    ...
    l($);
    for (var M = r || $, x = "", A = M; A != $; A = A.parent) A.cN && (x += p(A.cN, x, !0));
    var w = "",
      C = 0;
    try {
      for (var k, S, N = 0;;) {
        if (M.t.lastIndex = N, k = M.t.exec(o), !k) break;
        S = T(o.substr(N, k.index - N), k[0]), N = k.index + S
      }
      T(o.substr(N));
      for (var A = M; A.parent; A = A.parent) A.cN && (x += "</span>");
      return {
        r: C,
        value: x,
        language: t,
